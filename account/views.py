...
from account.serializers import RegisterSerializer,ForgotPasswordCompleteSerializer,ForgotPasswordSerializer
...
class ForgotPasswordAPIView(APIView):
    def post(self,request):
        ...
        return Response('Вам отправлено письмо для востановления проля!')
